  ...
  return (
    <div className="policy-container">
      <div className="policy-text">
        ...
        <p>
          AtlasFlux is a personal project that provides access to AI models (via
          OpenRouter and Replicate). The AI services operate on a Daily Credit
          System: registered users receive 30 free credits every 24 hours. Each
          standard chat message costs 2 credits; DeepSearch costs 4 credits.
          Image generation costs 15, 30, or 50 credits depending on quality
          mode. Credits are non‑transferable and have no monetary value.
        </p>
        ...
        <p>
          ...
          outages of third‑party providers (OpenRouter, Vercel, etc.). I am not
          liable for any direct or indirect damages arising from your use of the
          platform. AI outputs may contain errors; you are responsible for
          verifying critical information.
        </p>
        <h2>5. Intellectual Property</h2>
        <p>
          The original code, UI design, and the “AtlasFlux” brand are owned by
          me, Muhd Nabil. Users retain ownership of the content they input. The
          AI outputs are subject to the license terms of the respective models
